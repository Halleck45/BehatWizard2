test('Scenario can receive steps', function() {
    ...
    var step1 = new hbw.entity.step('given','I am a logged in user with following');
    step1.outline = outline1;

    var step2 = new hbw.entity.step('then', 'I sould see my name on the screen');

    var scenario1 = new hbw.entity.scenario();
    scenario1
    .addStep(step1)
    .addStep(step2);
    equal(scenario1.steps.length, 2, 'Steps are added to scenario');

    var step3 = new hbw.entity.step('given','Another condition');
