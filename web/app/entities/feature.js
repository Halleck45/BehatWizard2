 ...
 */
hbw.entity.feature = function(datas) {
    ...
    this.initialize = function(datas) {
        ...
        for(i in datas.scenarios) {
            scenario = new hbw.entity.scenario(datas.scenarios[i]);
            this.addScenario(scenario);
        }

        this.background = new hbw.entity.scenario(datas.background);
    ...
    this.removeScenario = function(scenario) {
        ...
        throw new hbw.entity.exception('Scenario cannot be removed : it was not found');
        return this;
    }
